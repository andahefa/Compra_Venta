    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <a href="articulo/create"><button class="btn btn-info">Nuevo Articulo</button></a>
                <div>
                  <table class="table table-condensed table-bordered">
                    ...
                    <tbody>
                        ...
                        <td><input type="button" name="editar" id="Editar" value="Editar" onclick="cargarArticulo('{{$articulo['id']}}','{{$articulo['categoria']}}','{{$articulo['estado']}}','{{$articulo['marca']}}','{{$articulo['referencia']}}','{{$articulo['descripcion']}}')" class="btn"></td>
                        </tr>
                        @endforeach
                    </tbody>
                  </table>
